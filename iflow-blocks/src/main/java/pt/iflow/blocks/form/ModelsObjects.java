...
public class ModelsObjects implements FieldInterface {
  ...
  public String getXML(Properties prop) {
    try {
      ...
      String width = prop.getProperty(ModelsObjects.WIDTH);
      ...
      String height = prop.getProperty(ModelsObjects.HEIGHT);
